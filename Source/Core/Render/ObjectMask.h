...
namespace GiiGa
{
    ...
    constexpr BlendMode operator|(BlendMode lhs, BlendMode rhs)
    {
        return static_cast<BlendMode>(toUnderlying(lhs) | toUnderlying(rhs));
    }

    constexpr ShadingModel operator|(ShadingModel lhs, ShadingModel rhs)
    {
        return static_cast<ShadingModel>(toUnderlying(lhs) | toUnderlying(rhs));
    }

    constexpr VertexTypes operator|(VertexTypes lhs, VertexTypes rhs)
    {
