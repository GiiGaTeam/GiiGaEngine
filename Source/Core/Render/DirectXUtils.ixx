...
export bool operator==(const D3D12_CONSTANT_BUFFER_VIEW_DESC& lhs, const D3D12_CONSTANT_BUFFER_VIEW_DESC& rhs)
{
...
struct std::hash<D3D12_SHADER_RESOURCE_VIEW_DESC>
{
    size_t operator()(const D3D12_SHADER_RESOURCE_VIEW_DESC& desc) const noexcept
    {
        ...
        {
            case D3D12_SRV_DIMENSION_BUFFER: hash_combine(seed, std::hash<UINT64>{}(desc.Buffer.FirstElement));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURE1D: hash_combine(seed, std::hash<UINT>{}(desc.Texture1D.MostDetailedMip));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURE1DARRAY: hash_combine(seed, std::hash<UINT>{}(desc.Texture1DArray.MostDetailedMip));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURE2D: hash_combine(seed, std::hash<UINT>{}(desc.Texture2D.MostDetailedMip));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURE2DARRAY: hash_combine(seed, std::hash<UINT>{}(desc.Texture2DArray.MostDetailedMip));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURE3D: hash_combine(seed, std::hash<UINT>{}(desc.Texture3D.MostDetailedMip));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURECUBE: hash_combine(seed, std::hash<UINT>{}(desc.TextureCube.MostDetailedMip));
                ...
                break;
            case D3D12_SRV_DIMENSION_TEXTURECUBEARRAY: hash_combine(seed, std::hash<UINT>{}(desc.TextureCubeArray.MostDetailedMip));
...
export bool operator==(const D3D12_SHADER_RESOURCE_VIEW_DESC& lhs, const D3D12_SHADER_RESOURCE_VIEW_DESC& rhs)
{
    ...
    {
        case D3D12_SRV_DIMENSION_BUFFER: return lhs.Buffer.FirstElement == rhs.Buffer.FirstElement &&
        ...
        case D3D12_SRV_DIMENSION_TEXTURE1D: return lhs.Texture1D.MostDetailedMip == rhs.Texture1D.MostDetailedMip &&
                                                   lhs.Texture1D.MipLevels == rhs.Texture1D.MipLevels &&
                                                   lhs.Texture1D.ResourceMinLODClamp == rhs.Texture1D.ResourceMinLODClamp;
        case D3D12_SRV_DIMENSION_TEXTURE1DARRAY: return lhs.Texture1DArray.MostDetailedMip == rhs.Texture1DArray.MostDetailedMip &&
                                                        ...
                                                        ResourceMinLODClamp;
        case D3D12_SRV_DIMENSION_TEXTURE2D: return lhs.Texture2D.MostDetailedMip == rhs.Texture2D.MostDetailedMip &&
        ...
        case D3D12_SRV_DIMENSION_TEXTURE2DARRAY: return lhs.Texture2DArray.MostDetailedMip == rhs.Texture2DArray.MostDetailedMip &&
                                                        ...
                                                        ResourceMinLODClamp;
        case D3D12_SRV_DIMENSION_TEXTURE3D: return lhs.Texture3D.MostDetailedMip == rhs.Texture3D.MostDetailedMip &&
                                                   lhs.Texture3D.MipLevels == rhs.Texture3D.MipLevels &&
                                                   lhs.Texture3D.ResourceMinLODClamp == rhs.Texture3D.ResourceMinLODClamp;
        case D3D12_SRV_DIMENSION_TEXTURECUBE: return lhs.TextureCube.MostDetailedMip == rhs.TextureCube.MostDetailedMip &&
...
struct std::hash<D3D12_UNORDERED_ACCESS_VIEW_DESC>
{
    size_t operator()(const D3D12_UNORDERED_ACCESS_VIEW_DESC& desc) const noexcept
    {
        ...
        switch (desc.ViewDimension)
        {
            case D3D12_UAV_DIMENSION_BUFFER: hashValue ^= std::hash<UINT64>()(desc.Buffer.FirstElement) ^
            ...
            case D3D12_UAV_DIMENSION_TEXTURE1D: hashValue ^= std::hash<UINT>()(desc.Texture1D.MipSlice);
                break;

            case D3D12_UAV_DIMENSION_TEXTURE1DARRAY: hashValue ^= std::hash<UINT>()(desc.Texture1DArray.MipSlice) ^
                                                     std::hash<UINT>()(desc.Texture1DArray.FirstArraySlice) ^
                                                     std::hash<UINT>()(desc.Texture1DArray.ArraySize);
                break;

            case D3D12_UAV_DIMENSION_TEXTURE2D: hashValue ^= std::hash<UINT>()(desc.Texture2D.MipSlice) ^
                                                std::hash<UINT>()(desc.Texture2D.PlaneSlice);
                break;

            case D3D12_UAV_DIMENSION_TEXTURE2DARRAY: hashValue ^= std::hash<UINT>()(desc.Texture2DArray.MipSlice) ^
            ...
            case D3D12_UAV_DIMENSION_TEXTURE3D: hashValue ^= std::hash<UINT>()(desc.Texture3D.MipSlice) ^
...
export bool operator==(const D3D12_UNORDERED_ACCESS_VIEW_DESC& lhs, const D3D12_UNORDERED_ACCESS_VIEW_DESC& rhs)
{
    ...
    switch (lhs.ViewDimension)
    {
        case D3D12_UAV_DIMENSION_BUFFER: return lhs.Buffer.FirstElement == rhs.Buffer.FirstElement &&
                                                lhs.Buffer.NumElements == rhs.Buffer.NumElements &&
                                                lhs.Buffer.StructureByteStride == rhs.Buffer.StructureByteStride &&
                                                lhs.Buffer.CounterOffsetInBytes == rhs.Buffer.CounterOffsetInBytes &&
                                                lhs.Buffer.Flags == rhs.Buffer.Flags;

        case D3D12_UAV_DIMENSION_TEXTURE1D: return lhs.Texture1D.MipSlice == rhs.Texture1D.MipSlice;

        case D3D12_UAV_DIMENSION_TEXTURE1DARRAY: return lhs.Texture1DArray.MipSlice == rhs.Texture1DArray.MipSlice &&
                                                        lhs.Texture1DArray.FirstArraySlice == rhs.Texture1DArray.FirstArraySlice &&
                                                        lhs.Texture1DArray.ArraySize == rhs.Texture1DArray.ArraySize;

        case D3D12_UAV_DIMENSION_TEXTURE2D: return lhs.Texture2D.MipSlice == rhs.Texture2D.MipSlice &&
                                                   lhs.Texture2D.PlaneSlice == rhs.Texture2D.PlaneSlice;

        case D3D12_UAV_DIMENSION_TEXTURE2DARRAY: return lhs.Texture2DArray.MipSlice == rhs.Texture2DArray.MipSlice &&
                                                        lhs.Texture2DArray.FirstArraySlice == rhs.Texture2DArray.FirstArraySlice &&
                                                        lhs.Texture2DArray.ArraySize == rhs.Texture2DArray.ArraySize &&
                                                        lhs.Texture2DArray.PlaneSlice == rhs.Texture2DArray.PlaneSlice;

        case D3D12_UAV_DIMENSION_TEXTURE3D: return lhs.Texture3D.MipSlice == rhs.Texture3D.MipSlice &&
...
struct std::hash<D3D12_RENDER_TARGET_VIEW_DESC>
{
    std::size_t operator()(const D3D12_RENDER_TARGET_VIEW_DESC& desc) const
    {
        ...
        switch (desc.ViewDimension)
        {
            case D3D12_RTV_DIMENSION_BUFFER: hash_combine(seed, std::hash<UINT64>{}(desc.Buffer.FirstElement));
                hash_combine(seed, std::hash<UINT>{}(desc.Buffer.NumElements));
                break;

            case D3D12_RTV_DIMENSION_TEXTURE1D: hash_combine(seed, std::hash<UINT>{}(desc.Texture1D.MipSlice));
                break;

            case D3D12_RTV_DIMENSION_TEXTURE1DARRAY: hash_combine(seed, std::hash<UINT>{}(desc.Texture1DArray.MipSlice));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture1DArray.FirstArraySlice));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture1DArray.ArraySize));
                break;

            case D3D12_RTV_DIMENSION_TEXTURE2D: hash_combine(seed, std::hash<UINT>{}(desc.Texture2D.MipSlice));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture2D.PlaneSlice));
                break;

            case D3D12_RTV_DIMENSION_TEXTURE2DARRAY: hash_combine(seed, std::hash<UINT>{}(desc.Texture2DArray.MipSlice));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture2DArray.FirstArraySlice));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture2DArray.ArraySize));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture2DArray.PlaneSlice));
                break;
            ...
            case D3D12_RTV_DIMENSION_TEXTURE2DMSARRAY: hash_combine(seed, std::hash<UINT>{}(desc.Texture2DMSArray.FirstArraySlice));
                hash_combine(seed, std::hash<UINT>{}(desc.Texture2DMSArray.ArraySize));
                break;

            case D3D12_RTV_DIMENSION_TEXTURE3D: hash_combine(seed, std::hash<UINT>{}(desc.Texture3D.MipSlice));
...
export bool operator==(const D3D12_RENDER_TARGET_VIEW_DESC& lhs, const D3D12_RENDER_TARGET_VIEW_DESC& rhs)
{
    if (lhs.Format != rhs.Format || lhs.ViewDimension != rhs.ViewDimension)
    {
        return false;
    ...
    switch (lhs.ViewDimension)
    {
        case D3D12_RTV_DIMENSION_BUFFER: return lhs.Buffer.FirstElement == rhs.Buffer.FirstElement &&
                                                lhs.Buffer.NumElements == rhs.Buffer.NumElements;

        case D3D12_RTV_DIMENSION_TEXTURE1D: return lhs.Texture1D.MipSlice == rhs.Texture1D.MipSlice;

        case D3D12_RTV_DIMENSION_TEXTURE1DARRAY: return lhs.Texture1DArray.MipSlice == rhs.Texture1DArray.MipSlice &&
                                                        lhs.Texture1DArray.FirstArraySlice == rhs.Texture1DArray.FirstArraySlice &&
                                                        lhs.Texture1DArray.ArraySize == rhs.Texture1DArray.ArraySize;

        case D3D12_RTV_DIMENSION_TEXTURE2D: return lhs.Texture2D.MipSlice == rhs.Texture2D.MipSlice &&
                                                   lhs.Texture2D.PlaneSlice == rhs.Texture2D.PlaneSlice;

        case D3D12_RTV_DIMENSION_TEXTURE2DARRAY: return lhs.Texture2DArray.MipSlice == rhs.Texture2DArray.MipSlice &&
                                                        lhs.Texture2DArray.FirstArraySlice == rhs.Texture2DArray.FirstArraySlice &&
                                                        lhs.Texture2DArray.ArraySize == rhs.Texture2DArray.ArraySize &&
                                                        lhs.Texture2DArray.PlaneSlice == rhs.Texture2DArray.PlaneSlice;

        case D3D12_RTV_DIMENSION_TEXTURE2DMS: return true; // No additional fields to compare

        case D3D12_RTV_DIMENSION_TEXTURE2DMSARRAY: return lhs.Texture2DMSArray.FirstArraySlice == rhs.Texture2DMSArray.FirstArraySlice &&
                                                          lhs.Texture2DMSArray.ArraySize == rhs.Texture2DMSArray.ArraySize;

        case D3D12_RTV_DIMENSION_TEXTURE3D: return lhs.Texture3D.MipSlice == rhs.Texture3D.MipSlice &&
                                                   lhs.Texture3D.FirstWSlice == rhs.Texture3D.FirstWSlice &&
                                                   lhs.Texture3D.WSize == rhs.Texture3D.WSize;
...
struct std::hash<D3D12_DEPTH_STENCIL_VIEW_DESC>
{
    size_t operator()(const D3D12_DEPTH_STENCIL_VIEW_DESC& desc) const
    {
        ...
        switch (desc.ViewDimension)
        {
            case D3D12_DSV_DIMENSION_TEXTURE1D: hashValue ^= std::hash<UINT>()(desc.Texture1D.MipSlice) + 0x9e3779b9 + (hashValue << 6) + (
                                                    hashValue >> 2);
                break;

            case D3D12_DSV_DIMENSION_TEXTURE1DARRAY: hashValue ^= std::hash<UINT>()(desc.Texture1DArray.MipSlice) + 0x9e3779b9 + (
            ...
            case D3D12_DSV_DIMENSION_TEXTURE2D: hashValue ^= std::hash<UINT>()(desc.Texture2D.MipSlice) + 0x9e3779b9 + (hashValue << 6) + (
                                                    hashValue >> 2);
                break;

            case D3D12_DSV_DIMENSION_TEXTURE2DARRAY: hashValue ^= std::hash<UINT>()(desc.Texture2DArray.MipSlice) + 0x9e3779b9 + (
                                                         hashValue << 6) + (hashValue >> 2);
            ...
            case D3D12_DSV_DIMENSION_TEXTURE2DMSARRAY: hashValue ^= std::hash<UINT>()(desc.Texture2DMSArray.FirstArraySlice) + 0x9e3779b9 +
                                                       (hashValue << 6) + (hashValue >> 2);
...
export bool operator==(const D3D12_DEPTH_STENCIL_VIEW_DESC& lhs, const D3D12_DEPTH_STENCIL_VIEW_DESC& rhs)
{
    ...
    switch (lhs.ViewDimension)
    {
        case D3D12_DSV_DIMENSION_TEXTURE1D: return lhs.Texture1D.MipSlice == rhs.Texture1D.MipSlice;

        case D3D12_DSV_DIMENSION_TEXTURE1DARRAY: return lhs.Texture1DArray.MipSlice == rhs.Texture1DArray.MipSlice &&
                                                        lhs.Texture1DArray.FirstArraySlice == rhs.Texture1DArray.FirstArraySlice &&
                                                        lhs.Texture1DArray.ArraySize == rhs.Texture1DArray.ArraySize;

        case D3D12_DSV_DIMENSION_TEXTURE2D: return lhs.Texture2D.MipSlice == rhs.Texture2D.MipSlice;

        case D3D12_DSV_DIMENSION_TEXTURE2DARRAY: return lhs.Texture2DArray.MipSlice == rhs.Texture2DArray.MipSlice &&
                                                        lhs.Texture2DArray.FirstArraySlice == rhs.Texture2DArray.FirstArraySlice &&
                                                        lhs.Texture2DArray.ArraySize == rhs.Texture2DArray.ArraySize;

        case D3D12_DSV_DIMENSION_TEXTURE2DMS: return true; // No extra fields to compare for TEXTURE2DMS

        case D3D12_DSV_DIMENSION_TEXTURE2DMSARRAY: return lhs.Texture2DMSArray.FirstArraySlice == rhs.Texture2DMSArray.FirstArraySlice &&
                                                          lhs.Texture2DMSArray.ArraySize == rhs.Texture2DMSArray.ArraySize;
...
export bool operator==(const D3D12_INDEX_BUFFER_VIEW& lhs, const D3D12_INDEX_BUFFER_VIEW& rhs)
{
    return lhs.BufferLocation == rhs.BufferLocation &&
           lhs.SizeInBytes == rhs.SizeInBytes &&
...
export bool operator==(const D3D12_VERTEX_BUFFER_VIEW& lhs, const D3D12_VERTEX_BUFFER_VIEW& rhs)
{
    return lhs.BufferLocation == rhs.BufferLocation &&
           lhs.SizeInBytes == rhs.SizeInBytes &&
