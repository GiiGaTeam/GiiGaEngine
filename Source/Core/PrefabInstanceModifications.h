...
namespace GiiGa
{
    using PropertyModificationKey = std::pair<Uuid, std::string>;
    ...
    using PrefabPropertyValue = Json::Value;

    using PrefabPropertyModifications = std::unordered_map<PropertyModificationKey, PrefabPropertyValue, PropertyModificationKeyHash>;

    struct PrefabInstanceModifications
    {
